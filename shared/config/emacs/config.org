...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Evan"
    user-mail-address "me@iamevan.me")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/evansmith/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/evansmith/bin" "/profile/bin" "/Users/evansmith/.npm-packages/bin" "/Users/evansmith/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
