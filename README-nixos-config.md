...
- [Installing](#installing)
  - [For MacOS](#for-macos)
    ...
    - [6. Optional: Setup secrets](#6-optional-setup-secrets)
      - [6a. Create a private Github repo to hold your secrets](#6a-create-a-private-github-repo-to-hold-your-secrets)
      - [6b. Install keys](#6b-install-keys)
        - [Copy keys from USB drive](#copy-keys-from-usb-drive)
  ...
  - [For NixOS](#for-nixos)
    ...
    - [2. Optional: Setup secrets](#2-optional-setup-secrets)
      - [2a. Create a private Github repo to hold your secrets](#2a-create-a-private-github-repo-to-hold-your-secrets)
      - [2b. Install keys](#2b-install-keys)
        - [Copy keys from USB drive](#copy-keys-from-usb-drive-1)
        - [Create new keys](#create-new-keys-1)
        - [Check existing keys](#check-existing-keys-1)
...
- [Deploying changes to your system](#deploying-changes-to-your-system)
  - [For MacOS](#for-macos-1)
      - [Optional script to save keystrokes](#optional-script-to-save-keystrokes)
  - [For NixOS](#for-nixos-1)
      - [Optional script to save keystrokes](#optional-script-to-save-keystrokes-1)
